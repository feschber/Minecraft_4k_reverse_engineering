...
public class Minecraft extends Applet implements Runnable
{
	...
	boolean[] mouseButtonsLastTime = new boolean[4];
	...
	//game variables
	float f1 = 64 + 32.5f;// 32.5f;
	float f2 = 65.0f;
	float f3 = 96.5f;
	
	float f4 = 0.0f, f5 = 0.0f, f6 = 0.0f;
	...
	public void update()
	{
		...
		f11 = (float) Math.sin(f8);
		f12 = (float) Math.cos(f8);
		block7: while (System.currentTimeMillis() - l > 10)
		{
			...
			f5 *= 0.99f;
			f6 *= 0.5f;
			f4 += f9 * (f14 += (float) (this.input.getKey(KeyEvent.VK_W) ? 1
					: 0 - (this.input.getKey(KeyEvent.VK_S) ? 1 : 0) * 0.02f)
					+ f10 * (f13 += (float) (this.input.getKey(KeyEvent.VK_D) ? 1 : 0)
							- (this.input.getKey(KeyEvent.VK_A) ? 1 : 0) * 0.02f));
			f6 += f10 * f14 - f9 * f13;
			f5 += 0.003f;
			for(int i8 = 0; i8 < 3; i8++)
			{
				...
				while (i12 < 12)
				{
					...
					if (i13 < 0 || i14 < 0 || i15 < 0 || i13 >= 64 || i14 >= 64 || i15 >= 64
							|| world.blockData[i13 + i14 * 64 + i15 * 4096] > 0)
					{
						if (i8 != 1)
							continue block7;
						if (this.input.getKey(32) && f5 > 0.0f)
						{
							// this.input.setKey(32,false);
							f5 = -0.1f;
							continue block7;
						}
						f5 = 0.0f;
		...
		i6 = i7 = 0;
		if (this.input.getMouse(1) && !mouseButtonsLastTime[1] && i4 > 0)
			world.blockData[i4] = 0;
		if (this.input.getMouse(3) && !mouseButtonsLastTime[3] && i4 > 0)
			world.blockData[i4 + i5] = 1;
		mouseButtonsLastTime[1] = input.getMouse(1);
		mouseButtonsLastTime[3] = input.getMouse(3);
				...
				while (i18 < 3)
				{
					...
					while ((double) f33 < d)
					{
						...
						if (i25 > 0)
						{
							...
							if (f33 < f26 && i9 == this.input.getMouseX() / 4
									&& i11 == this.input.getMouseY() / 4)
							{
								i82 = i24;
								i5 = 1;
								if (f27 > 0.0f)
